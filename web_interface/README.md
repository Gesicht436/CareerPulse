...
- [ ] **Project Scaffolding:** Initialized with Next.js, TS, and Tailwind v4.
- [ ] **Atomic Structure:** Created directories for molecules, organisms, hooks, and stores.
- [ ] **Global State:** Implemented `useResumeStore` and `useUIStore` with Zustand.
- [ ] **Secure Upload:** Built the `FileUploadZone` molecule with real-time feedback.
- [ ] **Responsive Design:** Centered and balanced layout for home, upload, and dashboard pages.
