...
from core_engine.datasets.service import data_layer_service
...
class SmartMatchService:
    async def match_against_database(self, resume_text: str, limit: int = 5) -> MultiJobMatchResponse:
        ...
        for job in top_jobs:
            ...
            # We wrap it in a SmartMatchRequest to reuse the existing logic
            req = SmartMatchRequest(resume_text=resume_text, jd_text=job.description)
