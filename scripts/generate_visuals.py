...
os.makedirs('generated_visuals', exist_ok=True)
...
def generate_vram_graph():
    ...
    plt.savefig('generated_visuals/vram_comparison.png', dpi=300, bbox_inches='tight')
    plt.close()
...
def generate_latency_graph():
    ...
    plt.savefig('generated_visuals/latency_comparison.png', dpi=300, bbox_inches='tight')
    plt.close()
...
def generate_arch_diagram():
    ...
    plt.savefig('generated_visuals/system_architecture.png', dpi=300, bbox_inches='tight')
    plt.close()
...
def generate_security_flow():
    ...
    plt.savefig('generated_visuals/security_pipeline.png', dpi=300, bbox_inches='tight')
    plt.close()
...
def generate_rag_diagram():
    ...
    plt.savefig('generated_visuals/rag_workflow.png', dpi=300, bbox_inches='tight')
    plt.close()
...
def generate_semantic_v_keyword():
    ...
    plt.savefig('generated_visuals/semantic_gap.png', dpi=300, bbox_inches='tight')
    plt.close()
...
def generate_cosine_similarity():
    ...
    plt.savefig('generated_visuals/cosine_similarity.png', dpi=300, bbox_inches='tight')
    plt.close()
...
def generate_pii_redaction():
    ...
    plt.savefig('generated_visuals/pii_redaction.png', dpi=300, bbox_inches='tight')
    plt.close()
...
def generate_benchmark_graph():
    ...
    plt.savefig('generated_visuals/llm_benchmarks.png', dpi=300, bbox_inches='tight')
    plt.close()
...
def generate_setup_flow():
    ...
    plt.savefig('generated_visuals/setup_flow.png', dpi=300, bbox_inches='tight')
    plt.close()
...
if __name__ == "__main__":
    ...
    generate_setup_flow()
    print("All visuals saved to generated_visuals/")
